...
const REQ_CLIENT_CONNECTION_PROFILE_PATH = 'sdk/profiles/requirements-client.yaml'
const DESGRP_CLIENT_CONNECTION_PROFILE_PATH = 'sdk/profiles/designgroup-client.yaml'
...
async function getPeerInfo(peer) {
    ...
    if (peerQueryResponse.local_peers.RequirementsMSP && peerQueryResponse.local_peers.RequirementsMSP.peers.length > 0){
        console.log(`\tRequirementsMSP: ${peerQueryResponse.local_peers.RequirementsMSP.peers[0].endpoint}`)
    }
    if (peerQueryResponse.local_peers.DesignGroupMSP && peerQueryResponse.local_peers.DesignGroupMSP.peers.length > 0){
        console.log(`\tDesignGroupMSP: ${peerQueryResponse.local_peers.DesignGroupMSP.peers[0].endpoint}`)
    }
